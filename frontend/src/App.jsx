...
const TERMINAL_LINES = [
  ...
  },
  {
    delay: 700,
    type: "out",
    text: "a1b2c3d4       nginx:alpine       Up 3 days     0.0.0.0:80->80/tcp",
  },
  {
    delay: 800,
    type: "out",
    text: "e5f6a7b8       node:20-alpine     Up 2 hours    0.0.0.0:3000->3000/tcp",
  },
  {
    delay: 900,
    type: "out",
    text: "c9d0e1f2       postgres:16        Up 3 days     0.0.0.0:5432->5432/tcp",
  },
  {
    delay: 1000,
    type: "out",
    text: "g3h4i5j6       redis:7-alpine     Up 3 days     0.0.0.0:6379->6379/tcp",
  },
  {
    delay: 1100,
    type: "out",
    text: "o1p2q3r4       prom/prometheus    Up 1 day      0.0.0.0:9090->9090/tcp",
  },
  ...
  { delay: 2400, type: "out", text: "12" },
  {
    delay: 3000,
    type: "cmd",
    text: 'docker stats --no-stream --format "{{.Name}}: {{.CPUPerc}}"',
  },
  ...
  return (
    <div className="cpu-bar-track">
      <div
        ...
        style={{ width: `${Math.min(value * 10, 100)}%`, background: color }}
      />
    </div>
  );
}
    ...
    <div className="terminal">
      <div className="terminal-bar">
        ...
        <span className="terminal-title">
          ubuntu@docker-lab: ~/my-docker-app
        </span>
      </div>
    ...
    <div className="app">
      ...
      <section className="hero">
        ...
        <p className="hero-sub">
          Your Dockerized React app is running. This is what containerization
      ...
      <section className="section">
        ...
        <div className="cards-grid">
          {CONTAINERS.map((c, i) => (
            <ContainerCard key={c.id} c={c} index={i} />
          ))}
        </div>
      </section>
        ...
        <div className="steps-row">
          {[
            ...
            <div
              className="step-card"
              key={i}
              style={{ "--accent": s.color, animationDelay: `${i * 100}ms` }}
            >
              <span className="step-n" style={{ color: s.color }}>
                {s.n}
              </span>
